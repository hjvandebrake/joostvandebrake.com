...
`;
  ...
  research(){
    ...
    <div class="pg-hd has-figure"><div class="wrap">
      ...
      <figure class="pg-hd-figure">
        <img src="/assets/illustrations/research.webp?v=20260811b" width="1000" height="750"
      ...
      <div class="wrap">
        <div class="block">
          ...
          <p>${T(
            ...
            'Opeenvolgende studies vervingen dat simpele aantal door de factoren die de uitkomst werkelijk bepalen: het verloop van de relatie tussen teamlidmaatschappen en prestatie over de tijd, de invloed van diensttijd binnen de organisatie, de rol van informatienetwerken, de vraag of rollen tussen teams verschillen of juist samenvallen, en de frequentie waarmee mensen daartussen wisselen.'
          )}</p>
          ...
          <p>${T(
            ...
            'De rode draad is dat dit ontwerpkeuzes van de organisatie zijn. Of werken in meerdere teams iets kost of oplevert, wordt bepaald door de manier waarop het werk is ingericht, niet door de inzet van het individu. Dat maakt de bevindingen bruikbaar: ze wijzen op keuzes die iemand daadwerkelijk kan maken.'
          )}</p>
        </div>
        ...
        <div class="block">
          ...
          <p>${T(
            ...
            'De meeste van mijn lopende projecten voer ik uit met collega’s in het buitenland. Met Tammy Rapp aan Ohio University en Saleem Mistry aan de University of Delaware onderzoek ik wanneer gelijktijdige teamrollen synergie opleveren en wanneer conflict, en coördineer ik het bijbehorende onderzoek met meerdere meetmomenten in organisaties. Met Martin Hoegl aan LMU München, Max Reinwald aan de Universiteit van Mannheim en Stefan Berger doe ik een dagboekstudie naar multiple team membership. Met Jessica Reif en Jonathon Cummings aan Duke University werkte ik aan een integratief overzicht van de temporele structuur van modern teamwerk, een samenwerking die teruggaat tot mijn Fulbright-periode bij het Duke Network Analysis Center.'
          )}</p>
          <p>${T(
  ...
  teaching(){
    ...
    <div class="pg-hd has-figure"><div class="wrap">
      ...
      <figure class="pg-hd-figure">
        <img src="/assets/illustrations/teaching.webp?v=20260811b" width="1000" height="750"
      ...
      <div class="wrap">
        ...
        <div class="block">
          ...
          <p>${T(
            ...
            'Ik sta open voor het begeleiden van nieuwe promovendi die aan verwante onderwerpen werken. <a href="mailto:h.j.van.de.brake@rug.nl" style="color:var(--red)">Neem gerust contact op</a>.'
          )}</p>
        </div>
  ...
  practice(){
    ...
    <div class="pg-hd has-figure"><div class="wrap">
      ...
      <figure class="pg-hd-figure">
        <img src="/assets/illustrations/practice.webp?v=20260811b" width="1000" height="750"
